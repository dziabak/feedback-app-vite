		...
		<div className="col-span-3 space-y-4">
			<div className="flex justify-between p-4 rounded-lg bg-c-dark-blue">
				<div className="flex items-center">
					...
					<p className="mr-8 text-lg font-bold text-c-white">6 Suggestion</p>
					<p className="text-sm text-c-white">
			...
			<Link
				to="/feedback-details"
				className="flex items-center justify-between px-8 py-4 rounded-lg bg-c-white">
